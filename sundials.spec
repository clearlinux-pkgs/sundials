...
Version  : 4.0.1
Release  : 14
URL      : https://github.com/LLNL/sundials/archive/v4.0.1.tar.gz
Source0  : https://github.com/LLNL/sundials/archive/v4.0.1.tar.gz
...
%prep
%setup -q -n sundials-4.0.1
pushd ..
cp -a sundials-4.0.1 buildavx2
popd
pushd ..
cp -a sundials-4.0.1 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1545406135
mkdir -p clr-build
pushd clr-build
