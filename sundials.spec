...
Version  : 7.1.0
Release  : 65
URL      : https://github.com/LLNL/sundials/archive/v7.1.0/sundials-7.1.0.tar.gz
Source0  : https://github.com/LLNL/sundials/archive/v7.1.0/sundials-7.1.0.tar.gz
...
%prep
%setup -q -n sundials-7.1.0
cd %{_builddir}/sundials-7.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718989102
mkdir -p clr-build
pushd clr-build
...
-DUSE_GENERIC_MATH=ON  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
...
cp %{_builddir}/sundials-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
cp %{_builddir}/sundials-%{version}/doc/shared/LicenseReleaseNumbers.rst %{buildroot}/usr/share/package-licenses/sundials/31d9bc0283a7404309c26f5f729b1f91e3e1a966 || :
cp %{_builddir}/sundials-%{version}/src/arkode/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
cp %{_builddir}/sundials-%{version}/src/cvode/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
cp %{_builddir}/sundials-%{version}/src/cvodes/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
cp %{_builddir}/sundials-%{version}/src/ida/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
cp %{_builddir}/sundials-%{version}/src/idas/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
cp %{_builddir}/sundials-%{version}/src/kinsol/LICENSE %{buildroot}/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf || :
export GOAMD64=v2
GOAMD64=v3
pushd clr-build-avx2
%make_install_v3  || :
...
/usr/share/sundials/examples/cvode/CXX_serial/cv_heat2D.hpp
/usr/share/sundials/examples/cvode/CXX_serial/cv_heat2D.out
/usr/share/sundials/examples/cvode/CXX_serial/cv_kpr.cpp
/usr/share/sundials/examples/cvode/CXX_serial/cv_kpr.hpp
/usr/share/sundials/examples/cvode/CXX_serial/cv_kpr.out
/usr/share/sundials/examples/cvode/CXX_serial/example_utilities.hpp
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsundials_arkode.so.6.1.0
/V3/usr/lib64/libsundials_core.so.7.1.0
/V3/usr/lib64/libsundials_cvode.so.7.1.0
/V3/usr/lib64/libsundials_cvodes.so.7.1.0
/V3/usr/lib64/libsundials_ida.so.7.1.0
/V3/usr/lib64/libsundials_idas.so.6.1.0
/V3/usr/lib64/libsundials_kinsol.so.7.1.0
/V3/usr/lib64/libsundials_nvecmanyvector.so.7.1.0
/V3/usr/lib64/libsundials_nvecopenmp.so.7.1.0
/V3/usr/lib64/libsundials_nvecpthreads.so.7.1.0
/V3/usr/lib64/libsundials_nvecserial.so.7.1.0
/V3/usr/lib64/libsundials_sunlinsolband.so.5.1.0
/V3/usr/lib64/libsundials_sunlinsoldense.so.5.1.0
/V3/usr/lib64/libsundials_sunlinsolpcg.so.5.1.0
/V3/usr/lib64/libsundials_sunlinsolspbcgs.so.5.1.0
/V3/usr/lib64/libsundials_sunlinsolspfgmr.so.5.1.0
/V3/usr/lib64/libsundials_sunlinsolspgmr.so.5.1.0
/V3/usr/lib64/libsundials_sunlinsolsptfqmr.so.5.1.0
/V3/usr/lib64/libsundials_sunmatrixband.so.5.1.0
/V3/usr/lib64/libsundials_sunmatrixdense.so.5.1.0
/V3/usr/lib64/libsundials_sunmatrixsparse.so.5.1.0
/V3/usr/lib64/libsundials_sunnonlinsolfixedpoint.so.4.1.0
/V3/usr/lib64/libsundials_sunnonlinsolnewton.so.4.1.0
/V4/usr/lib64/libsundials_arkode.so.6.1.0
/V4/usr/lib64/libsundials_core.so.7.1.0
/V4/usr/lib64/libsundials_cvode.so.7.1.0
/V4/usr/lib64/libsundials_cvodes.so.7.1.0
/V4/usr/lib64/libsundials_ida.so.7.1.0
/V4/usr/lib64/libsundials_idas.so.6.1.0
/V4/usr/lib64/libsundials_kinsol.so.7.1.0
/V4/usr/lib64/libsundials_nvecmanyvector.so.7.1.0
/V4/usr/lib64/libsundials_nvecopenmp.so.7.1.0
/V4/usr/lib64/libsundials_nvecpthreads.so.7.1.0
/V4/usr/lib64/libsundials_nvecserial.so.7.1.0
/V4/usr/lib64/libsundials_sunlinsolband.so.5.1.0
/V4/usr/lib64/libsundials_sunlinsoldense.so.5.1.0
/V4/usr/lib64/libsundials_sunlinsolpcg.so.5.1.0
/V4/usr/lib64/libsundials_sunlinsolspbcgs.so.5.1.0
/V4/usr/lib64/libsundials_sunlinsolspfgmr.so.5.1.0
/V4/usr/lib64/libsundials_sunlinsolspgmr.so.5.1.0
/V4/usr/lib64/libsundials_sunlinsolsptfqmr.so.5.1.0
/V4/usr/lib64/libsundials_sunmatrixband.so.5.1.0
/V4/usr/lib64/libsundials_sunmatrixdense.so.5.1.0
/V4/usr/lib64/libsundials_sunmatrixsparse.so.5.1.0
/V4/usr/lib64/libsundials_sunnonlinsolfixedpoint.so.4.1.0
/V4/usr/lib64/libsundials_sunnonlinsolnewton.so.4.1.0
/usr/lib64/libsundials_arkode.so.6
/usr/lib64/libsundials_arkode.so.6.1.0
/usr/lib64/libsundials_core.so.7
/usr/lib64/libsundials_core.so.7.1.0
/usr/lib64/libsundials_cvode.so.7
/usr/lib64/libsundials_cvode.so.7.1.0
/usr/lib64/libsundials_cvodes.so.7
/usr/lib64/libsundials_cvodes.so.7.1.0
/usr/lib64/libsundials_ida.so.7
/usr/lib64/libsundials_ida.so.7.1.0
/usr/lib64/libsundials_idas.so.6
/usr/lib64/libsundials_idas.so.6.1.0
/usr/lib64/libsundials_kinsol.so.7
/usr/lib64/libsundials_kinsol.so.7.1.0
/usr/lib64/libsundials_nvecmanyvector.so.7
/usr/lib64/libsundials_nvecmanyvector.so.7.1.0
/usr/lib64/libsundials_nvecopenmp.so.7
/usr/lib64/libsundials_nvecopenmp.so.7.1.0
/usr/lib64/libsundials_nvecpthreads.so.7
/usr/lib64/libsundials_nvecpthreads.so.7.1.0
/usr/lib64/libsundials_nvecserial.so.7
/usr/lib64/libsundials_nvecserial.so.7.1.0
/usr/lib64/libsundials_sunlinsolband.so.5
/usr/lib64/libsundials_sunlinsolband.so.5.1.0
/usr/lib64/libsundials_sunlinsoldense.so.5
/usr/lib64/libsundials_sunlinsoldense.so.5.1.0
/usr/lib64/libsundials_sunlinsolpcg.so.5
/usr/lib64/libsundials_sunlinsolpcg.so.5.1.0
/usr/lib64/libsundials_sunlinsolspbcgs.so.5
/usr/lib64/libsundials_sunlinsolspbcgs.so.5.1.0
/usr/lib64/libsundials_sunlinsolspfgmr.so.5
/usr/lib64/libsundials_sunlinsolspfgmr.so.5.1.0
/usr/lib64/libsundials_sunlinsolspgmr.so.5
/usr/lib64/libsundials_sunlinsolspgmr.so.5.1.0
/usr/lib64/libsundials_sunlinsolsptfqmr.so.5
/usr/lib64/libsundials_sunlinsolsptfqmr.so.5.1.0
/usr/lib64/libsundials_sunmatrixband.so.5
/usr/lib64/libsundials_sunmatrixband.so.5.1.0
/usr/lib64/libsundials_sunmatrixdense.so.5
/usr/lib64/libsundials_sunmatrixdense.so.5.1.0
/usr/lib64/libsundials_sunmatrixsparse.so.5
/usr/lib64/libsundials_sunmatrixsparse.so.5.1.0
/usr/lib64/libsundials_sunnonlinsolfixedpoint.so.4
/usr/lib64/libsundials_sunnonlinsolfixedpoint.so.4.1.0
/usr/lib64/libsundials_sunnonlinsolnewton.so.4
/usr/lib64/libsundials_sunnonlinsolnewton.so.4.1.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/sundials/31d9bc0283a7404309c26f5f729b1f91e3e1a966
/usr/share/package-licenses/sundials/b20db85b4c8366418e5994f1a5219da3615472bf

%files staticdev
%defattr(-,root,root,-)
/usr/lib64/libsundials_arkode.a
/usr/lib64/libsundials_core.a
