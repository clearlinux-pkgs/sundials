...
Version  : 3.1.2
Release  : 4
URL      : https://github.com/LLNL/sundials/archive/v3.1.2.tar.gz
Source0  : https://github.com/LLNL/sundials/archive/v3.1.2.tar.gz
...
%prep
%setup -q -n sundials-3.1.2
%patch1 -p1
pushd ..
cp -a sundials-3.1.2 buildavx2
popd
pushd ..
cp -a sundials-3.1.2 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1533075482
mkdir clr-build
pushd clr-build
